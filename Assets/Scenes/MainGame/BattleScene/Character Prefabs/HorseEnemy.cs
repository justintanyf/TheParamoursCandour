...
public class HorseEnemy : EnemyStats
{
    public override KeyValuePair<String, int> GetNextEnemyMove()
    {
        ...
        if (rand < 0.3) // Tackle
        {
            return new KeyValuePair<string, int>("Fiery Backkick", 30 + this.enemyLevel * 2);
        }
        else //Ember
        {
            ...
            return new KeyValuePair<String, int>("Engulf", 20 + this.enemyLevel * 2);
        }
    }
}
